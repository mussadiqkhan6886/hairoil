...
export default function OrderTable({ orders }: { orders: Order[] }) {
  ...
  renderCell: (params) => {
    ...
    return (
      ...
      >
        <option value="pending" style={{ backgroundColor: "#facc15", color: "white" }}>
          Pending
        </option>
        <option value="processing" style={{ backgroundColor: "#60a5fa", color: "white" }}>
          Processing
        </option>
        <option value="shipped" style={{ backgroundColor: "#34d399", color: "white" }}>
          Shipped
        </option>
        <option value="delivered" style={{ backgroundColor: "#22c55e", color: "white" }}>
          Delivered
        </option>
        <option value="cancelled" style={{ backgroundColor: "#f87171", color: "white" }}>
          Cancelled
        </option>
      </select>
    );
